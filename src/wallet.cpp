...
// nimbuscoin: total coins staked (non-spendable until maturity)
...
// nimbuscoin: check 'spent' consistency between wallet and txindex
// nimbuscoin: fix wallet spent state according to txindex
...
// nimbuscoin: disable transaction (only for coinstake)
